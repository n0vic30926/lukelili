...
def check_foundation_files():
    ...
    required = [
        ...
        "data/examples/market_evidence.example.json",
        ...
        "scripts/common/recommendations.py",
        "scripts/common/report_decision_context.py",
        ...
        "scripts/common/research_coverage.py",
        ...
        "scripts/mock_narrative_evidence_test.py",
        ...
        "scripts/mock_ideal_agent_readiness_test.py",
        ...
        "scripts/mock_research_coverage_test.py",
        ...
        "scripts/mock_research_synthesis_test.py",
        "scripts/mock_risk_research_test.py",
        "scripts/mock_review_research_test.py",
