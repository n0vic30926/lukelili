...
def run_research_dispatch_test():
    ...
    _assert_contains(output, "data_requirements=macro_rates,fx_rates,liquidity_indicators")
    _assert_contains(output, "- security: individual security fundamentals, valuation, filings")
    _assert_contains(output, "data_requirements=portfolio_context,financial_statements,announcements,valuation_metrics")
