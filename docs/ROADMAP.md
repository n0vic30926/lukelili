...
- expand historical review beyond later-report evidence into report-content outcome attribution;
...
- historical review aggregates confirmed, pending, and rejected actions plus confirmed-action outcome status, quality, checklist evidence, and later-report evidence without printing private details.
