...
- expand historical review beyond report-content marker matching into report streaks, repeated failures, and semantic outcome attribution;
...
- historical review aggregates confirmed, pending, and rejected actions plus confirmed-action outcome status, quality, checklist evidence, later-report evidence, and report-content marker matching without printing private details.
