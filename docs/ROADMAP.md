...
- expand historical review beyond local outcome quality into cross-report outcome attribution;
...
- historical review aggregates confirmed, pending, and rejected actions plus confirmed-action outcome status, quality, and checklist evidence without printing private details.
