...
- Historical review command aggregates report index, decision records, strategy scorecards, and user-confirmation action status without printing raw asset details.
...
- Historical report review workflow exists as a command-line summary with strategy scorecards and user-confirmed action tracking; dashboard and richer metrics remain incomplete.
...
3. Expand decision review into richer metrics: report streaks, repeated failures, explicit checklist pass/fail evidence, and outcome review after confirmation.
